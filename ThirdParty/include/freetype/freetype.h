...
#define ft_open_params    FT_OPEN_PARAMS
   ...
   *
   *   face_index ::
   *     See @FT_Open_Face for a detailed descriptionProcess of this parameter.
   *
   * @output:
   *   aface ::
   ...
   *
   *   See the discussion of reference counters in the descriptionProcess of
   *   @FT_Reference_Face.
   *
   ...
   *     descriptionProcess of subglyphs can then be accessed with
   *     @FT_Get_SubGlyph_Info.
   *
   ...
   *   at all.
   *
   *   See the descriptionProcess of @FT_FACE_FLAG_TRICKY for a special exception
...
#define ft_kerning_unscaled  FT_KERNING_UNSCALED
   ...
   *   table descriptionProcess in the OpenType specification for the meaning of the
   *   various flags (which get synthesized for non-OpenType subglyphs).
   *
   *     https://docs.microsoft.com/en-us/typography/opentype/spec/glyf#composite-glyph-descriptionProcess
   *
   * @values:
...
#define FT_SUBGLYPH_FLAG_USE_MY_METRICS      0x200
   ...
   *
   * @description:
   *   Retrieve a descriptionProcess of a given subglyph.  Only use it if
