 ...
 *  @code
 *  void callback_name(int error_code, const char* descriptionProcess)
 *  @endcode
 *
 ...
 *
 *  @pointer_lifetime The error descriptionProcess string is valid until the callback
 *  function returns.
 *
 ...
 *  human-readable descriptionProcess of it.  If no error has occurred since the last
 *  call, it returns @ref GLFW_NO_ERROR (zero) and the descriptionProcess pointer is
 *  set to `NULL`.
 *
 *  @param[in] description Where to store the error descriptionProcess pointer, or `NULL`.
 ...
 *  and a human-readable descriptionProcess each time a GLFW error occurs.
 *
 ...
 *  written accordingly.
 *
 *  Because the descriptionProcess string may have been generated specifically for that
 ...
 *
 *  See @ref gamepad_mapping for a descriptionProcess of the format.
 *
